...
class OrderInfo(models.Model):
    ...
    trade_str = models.CharField(max_length=50,null=True,blank=True,verbose_name=u"随机数")
    trade_no = models.CharField(max_length=100,unique=True,null=True,blank=True,verbose_name=u"")
